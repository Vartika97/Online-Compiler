...
border:1px solid #baf; z-index:10";
...
function onResize() {
    ...
    container.style.width = (width*95)/100 + "px";
    container.style.height = (document.documentElement.clientHeight*70)/100 - consoleHeight + "px";
    env.split.resize();
...
const med = document.getElementById('hiddenInp');
